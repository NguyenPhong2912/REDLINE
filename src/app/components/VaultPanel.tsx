...
export function VaultPanel() {
  ...
  return (
    <div className="rounded-2xl p-6 relative overflow-hidden" style={{ background: "rgba(11,17,16,0.6)", border: `1px solid ${M}18`, boxShadow: "0 8px 40px rgba(0,0,0,0.45)" }}>
      ...
      <div className="flex items-start gap-4 flex-wrap">
        ...
        <div className="flex-1 min-w-[220px]">
          ...
          {!owner && <div className="text-sm mt-1" style={{ ...sans, color: "#64748b" }}>Connect a wallet to see its vault.</div>}
          {owner && (
            <>
              <div className="text-3xl font-bold tracking-tight mt-1" style={{ ...mono, color: "#e2e8f0" }}>{balance} <span className="text-base" style={{ color: "#64748b" }}>dUSDC</span></div>
              <div className="text-[10px] mt-1 flex gap-3 flex-wrap" style={{ ...mono, color: "#475569" }}>
        ...
        {owner && (
          <div className="flex items-center gap-2 flex-wrap">
            <input value={amount} onChange={e => setAmount(e.target.value.replace(/[^\d.]/g, ""))} aria-label="Withdraw amount in dUSDC" className="w-24 px-3 py-2 rounded-xl text-xs text-right" style={{ ...mono, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", color: "#e2e8f0" }} />
